...
units <- data.frame( var_name = c("fixed.acidity", "volatile.acidity", 
                      ...
                      "pH", "sulphates", "alcohol", "quality", "quality.f"),
...
ggcorr(redwine[,1:12],low = "steelblue", mid = "white", high = "darkred", nbreaks = 8)
```
...
```{r echo=FALSE, fig.cap="**Figure 7.0**", results="hide"}
p1 <- ggplot( aes(y = fixed.acidity, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p2 <- ggplot( aes(y = volatile.acidity, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p3 <- ggplot( aes(y = citric.acid, x = quality), data = redwine) +
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p4 <- ggplot( aes(y = residual.sugar, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p5 <- ggplot( aes(y = chlorides, x =quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p6 = ggplot( aes(y = free.sulfur.dioxide, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p7 <- ggplot( aes(y = total.sulfur.dioxide, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p8 <- ggplot( aes(y = density, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p9 <- ggplot( aes(y = pH, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p10 <- ggplot( aes(y = sulphates, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")

p11 <- ggplot( aes(y = alcohol, x = quality), data = redwine) + 
  geom_jitter(alpha = .5) + geom_smooth( method = "lm")
...
ggplot(aes(quality.f, fixed.acidity), data = redwine) +
  geom_jitter( alpha = .3)  +
...
ggplot(aes(quality.f, volatile.acidity), data = redwine) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, citric.acid), data = redwine) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, residual.sugar), data = subset(redwine, redwine$residual.sugar < 10)) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
```{r echo=FALSE, fig.cap="**Figure 11.**"}
ggplot(aes(quality.f, chlorides), data = subset(redwine, redwine$chlorides < 0.4)) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, free.sulfur.dioxide), data = subset(redwine, redwine$free.sulfur.dioxide < 50)) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, total.sulfur.dioxide), data = subset(redwine, redwine$total.sulfur.dioxide < 200)) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, density), data = redwine) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, pH), data = redwine) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
ggplot(aes(quality.f, sulphates), data = subset(redwine, redwine$sulphates < 1.75)) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
```{r echo=FALSE, fig.cap="**Figure 17.**"}
ggplot(aes(quality.f, alcohol), data = subset(redwine, redwine$alcohol < 14 )) +
  geom_jitter( alpha = .3)  +
  geom_boxplot( alpha = .5,color = 'blue')+
  stat_summary(fun.y = "mean", 
               geom = "point", 
...
```{r echo=FALSE, fig.cap="**Figure 18.**", Multivariate_Plots}
...
```{r echo=FALSE, fig.cap="**Figure 19.**", Plot_One_Distribution_Red_Wine_Quality}
...
```{r echo=FALSE, warning=FALSE, fig.cap="**Figure 20.**",Plot_Two_Correlation_Between_Objective_Parameters}
...
```{r echo=FALSE, warning=FALSE, fig.cap="**Figure 21.**", Alcohol_Volatile_Acidity}
